    ...
    state = {
      ...
      getFilteredProjects = () => {
        ...
        const filteredProjects = appsList.filter(
          eachprojectDetails => eachprojectDetails.category === activeTabId && eachprojectDetails.appName.toLowerCase().includes(searchInput.toLowerCase())
        )
        ...
        return(
            <div className='App-store-container'>
                ...
                <div className='card-container'> 
                    ...
                    <input  onChange={this.onChangeSearchInput} type="search" className='search-input' placeholder='Search' />
                    <img src="https://assets.ccbp.in/frontend/react-js/app-store/app-store-search-img.png " alt="search icon" className='search'/>
                    </div>
                    <ul className='tab-button'>
                        {tabsList.map(tabDetails=>(
                            <TabItem key={tabDetails.tabId}
                            tabDetails={tabDetails}   clickTabItem={this.clickTabItem}
